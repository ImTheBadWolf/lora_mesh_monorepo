...
Český Telekomunikačný úrad \cite{ctu} stanovuje v \textit{všeobecné oprávnění č. VO-R/10/07.2021-8 \cite{vor}}, že 
...
vysielací výkon 25 mW. Znamená to teda, že zariadenia môžu každú hodinu vysielať maximálne po dobu 36 sekúnd.
...
V Európe je možné mimo 866MHz pásma používať aj 433MHz pásmo. Okrem toho existuje ešte globálne používaná frekvencia 2.4 GHz.
\begin{figure}[h!]
	\centering
...
%TODO viacej textu sem. Napr ze su tam dake skupiny zariadeni, su tam dake stanovene limity atd
...
Výrobca Semtech \cite{semtech}, prináša LoRa chipy série SX127x a SX126x. V dnešnej dobe sú to najrozšírenejšie používané LoRa chipy.
Ponukajú vysoký výkon za pomerne nízku cenu.

\subsection{SX127x}

SX127x LoRa moduly používajú frequency hopping spread-spectrum moduláciu. Čo znamená, že viaceré vysielané signály zaberajú rovnaký kanál, ktorý ma vysokú ochranu proti rušeniu a zároveň majú nízku spotrebu energie.
