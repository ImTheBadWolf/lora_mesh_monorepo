...
reťazca, ktorý bude obsahovať dáta z senzorov. Tento typ sprav avšak oproti obyčajnej textovej správe ponuka možnosť nastaviť 
...
Dátové rámce sa budú líšiť na základe typu správy. V tabuľkách \ref{tab:textFrame}, \ref{tab:trReqFrame}, \ref{tab:trFrame}, \ref{tab:ackFrame}, \ref{tab:sensorFrame} 
je uvedená štruktúra dátových rámcov pre jednotlivé typy správ. 
...
\begin{table}[!h]
	\centering
  \caption{Štruktúra dátového rámcu pre správy typu žiadosť o traceroute.}
  \begin{tabular}{|c|c|}
    \toprule
    1B & 1B \\
    \midrule
    ...
    \midrule
  \end{tabular}
  \label{tab:trReqFrame}
\end{table}

\begin{table}[!h]
	\centering
  \caption{Štruktúra dátového rámcu pre správy typu odpoveď na traceroute.}
  \begin{tabular}{|c|c|}
    \toprule
    1B & 0 -- 239B \\
    \midrule
...
V dátových niektorých rámcoch môžme vidieť položku počet skokov. Do tejto položky bude pri vytvorení novej správy zapísaný maximálny počet skokov, ktoré môže správa vykonať 
pri prenose sieťou. Každý uzol, predtým ako správu prepošle ďalej zmenší počet skokov o jedna. Ak sa počet skokov dostane na nulu tak správu ďalej nespracovávame.

V rámcoch taktiež nájdeme položku pôvodný počet skokov. Do tejto položky bude taktiež pri vytvorení novej správy zapísaný maximálny počet skokov. Hodnota v tejto položke sa 
ale už ďalej nemení. Bude slúžiť k tomu, aby prijímateľ dokázal zistiť, koľko preskokov správe zabralo, aby správa dorazila až k nemu. Túto informáciu bude možné 
...
\begin{table}[!h]
	\centering
  \caption{Štruktúra dátového rámcu pre potvrdzovacie ACK správy.}
  \begin{tabular}{|c|c|}
    \toprule
    1B & 4B \\
    \midrule
...
\begin{table}[!h]
	\centering
  \caption{Štruktúra dátového rámcu pre senzorové dáta.}
  \begin{tabular}{|c|c|}
    \toprule
    2B & 0 -- 238B \\
    \midrule
